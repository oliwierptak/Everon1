...
* Maker sure that parameter 'username' in _POST consists only lower cased letters and is not less then 4 characters.
* Maker sure that parameter 'password' in _POST consists alphanumerical symbols and is not less then 3 characters.
